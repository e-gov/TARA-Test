...
| loginservice.healthUrl               | /actuator/health                                                                                                                     | Service health endpoint.                                      |
| loginservice.healthReadinessUrl      | /actuator/health/readiness                                                                                                           | Service health readiness endpoint.                            |
| loginservice.healthLivenessUrl       | /actuator/health/liveness                                                                                                            | Service health liveness endpoint.                             |
| loginservice.prometheusUrl           | /actuator/prometheus                                                                                                                 | Service prometheus endpoint.                                  |
